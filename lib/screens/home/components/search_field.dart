...
class _SearchFieldState extends State<SearchField> {
  ...
  final List<String> _categories = [
    "Filters", "Spark Plugs", "Brake Pads", "Tires", "Car Battery", "Alternator", "ECU", "Radiator", "Head Gasket", "Turbocharger", "Timing Belt", "Dual Mass Flywheel"
  ];
  
  final List<String> _brands = [
    "Auto Miraj", "Kleen Park", "Care Point", "Platinum Auto Spa", "Magic Touch-up", "Laugfs", "Hybrid Motors"
  ];
  ...
  void _onSuggestionSelected(BuildContext context, SearchSuggestion suggestion) {
    ...
    switch (suggestion.type) {
      ...
      case SuggestionType.category:
        // Navigate to products screen for categories
        Navigator.pushNamed(
          context,
      ...
      case SuggestionType.brand:
        // Navigate to home screen and scroll to top brands section
        Navigator.pushNamed(
          context,
          '/',  // Home route
          arguments: {'scrollToTopBrands': true},  // Pass argument to scroll to brands section
        );
        break;
    }
