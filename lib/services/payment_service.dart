...
class PaymentService {
  // PayPal credentials for autofixlk123@gmail.com
  static const String _clientId = 'ASzOb-0GUWIxKOJQdgLQeUMTdxf7jv2WCLB0niczlyurJJYDfEjJN_subQWk5ay1VHtWHtaMxGBwbpE1';
  static const String _secretKey = 'ECku8RPEQ4p8grjCr4yXY2pn8NhinJMc1sgwGnX7uu07unt5baelf2gMyc0HAGiDRwEsEBHKAFLf1VaH';
          ...
          'purchase_units': [
            {
              ...
              'description': 'AutoFix-LK Purchase'
            }
          ],
          'application_context': {
            'brand_name': 'AutoFix-LK',
            'landing_page': 'LOGIN',
            'user_action': 'PAY_NOW',
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onNavigationRequest: (NavigationRequest request) {
            ...
            if (request.url.contains('localhost:8080/success')) {
              Navigator.pop(context, 'success');
              return NavigationDecision.prevent;
            }
            if (request.url.contains('localhost:8080/cancel')) {
